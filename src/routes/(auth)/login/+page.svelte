<script lang="ts">
	...
	import { Label, Input, Card, Button, Checkbox } from "flowbite-svelte";
	import { fade } from 'svelte/transition';

	export let form;
</script>

<div transition:fade class="transition ease-in-out delay-300 flex justify-center items-center h-screen">
	<Card  class="w-screen">
